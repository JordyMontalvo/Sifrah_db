...
let r = {
  'active':   [0.283, 0.125, 0.1667, 0.125, 0.833, 0.125],
  'BRONCE':   [0.283, 0.125, 0.1667, 0.125, 0.833, 0.125],
  'PLATA':    [0.283, 0.125, 0.1667, 0.125, 0.833, 0.125],
  'ORO':      [0.283, 0.125, 0.1667, 0.125, 0.833, 0.125],
  'ZAFIRO':   [0.283, 0.125, 0.1667, 0.125, 0.833, 0.125],
...
function calc_range(arr, p) {
  ...
  if(n >= 3 && arr.reduce((a, b, c) => a + (b > (c == 0 ? 0.3637 : 0.3334) * 3300  ? (c == 0 ? 0.3637 : 0.3334) * 3300  : b), 0) >= 3300)  return 'ZAFIRO'
  if(n >= 3 && arr.reduce((a, b, c) => a + (b > (c == 0 ? 0.4167 : 0.3334) * 1800  ? (c == 0 ? 0.4167 : 0.3334) * 1800  : b), 0) >= 1800)  return 'ORO'
  if(n >= 2 && arr.reduce((a, b, c) => a + (b > (c == 0 ? 0.5556 : 0.50)   * 900   ? (c == 0 ? 0.5556 : 0.50)   * 900   : b), 0) >= 900 )  return 'PLATA'
  if(n >= 2 && arr.reduce((a, b, c) => a + (b > (c == 0 ? 0.6667 : 0.50)   * 300   ? (c == 0 ? 0.6667 : 0.50)   * 300   : b), 0) >= 300 )  return 'BRONCE'
...
function levels() {
  for(let node of tree) {
    ...
    if(node.rank == 'ZAFIRO') node.levels = 6
    if(node.rank == 'ORO')    node.levels = 6
    if(node.rank == 'PLATA')  node.levels = 6
    if(node.rank == 'BRONCE') node.levels = 6
    if(node.rank == 'active') node.levels = 6
  }
}
